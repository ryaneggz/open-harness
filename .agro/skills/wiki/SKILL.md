...
- **Knowledge root**: entity pages at `.agro/knowledge/source/<slug>.md`, pattern
  ...
  external snapshots at `.agro/knowledge/raw/<yyyy-mm-dd>-<slug>.md`. Both entry
...
- **Canonical schema**: frontmatter fields, the three kinds, provenance forms,
  ...
  `.agro/skills/wiki/references/schema.md`. The reference docs and this dispatcher
...
- **Index reflects the tracked entry set**: `.agro/knowledge/README.md`'s Index
