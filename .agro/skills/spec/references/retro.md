...
> (`.agro/skills/spec/SKILL.md`). Argument form: `retro <slug> [--dry-run]`.
...
Read `.agro/skills/retro/SKILL.md` and follow it with `--task <slug>` (plus
...
(guarded by `.agro/evals/probes/retro-deterministic-contract.sh`) and `/wiki
...
- `.agro/skills/retro/SKILL.md` — the engine; report-only by contract
- `.agro/skills/wiki/references/compile.md` — the durable pattern writer
- `.agro/skills/spec/references/execute.md` — the tail this runs inside
