...
- [How It Works](./how-it-works.md) — boot sequence and container environment.
- [Project Structure](./structure.md) — repo layout.
- [Heartbeats guide](../guide/heartbeats.md) — multi-root discovery, env vars, log layout.
