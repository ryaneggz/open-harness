...
See the [Workspace guide](../guide/workspace.md) for full details on each file and the ownership model. For how multiple agents share one sandbox via git worktrees, see [Orchestrator + Worktrees](./orchestrator-worktrees.md).
