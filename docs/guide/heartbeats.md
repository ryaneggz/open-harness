...
A single heartbeat daemon inside the sandbox watches every worktree's `heartbeats/` directory at once — see [Orchestrator + Worktrees](../architecture/orchestrator-worktrees.md) for the topology.
