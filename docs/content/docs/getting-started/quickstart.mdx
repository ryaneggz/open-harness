...
See the [Multi-Sandbox SSH guide](/docs/guide/multi-sandbox-ssh) for full setup.
...
See [Onboarding](/docs/getting-started/onboarding) for the full walkthrough.
...
- [What's installed](/docs/getting-started/whats-installed) — full inventory of pre-installed tools
- [Compose overlays](/docs/guide/overlays) — add Postgres, Slack, Docker-in-Docker, SSH
- [Workspace structure](/docs/guide/workspace) — identity files, memory, heartbeats
- [Permissions & security](/docs/guide/permissions) — what agents can and can't do
