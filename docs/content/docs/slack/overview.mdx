...
- [Setup](/docs/slack/setup) — Configure your Slack app and connect the bot
- [How It Works](/docs/slack/how-it-works) — Message flow and workspace layout
- [Events](/docs/slack/events) — Schedule tasks and reminders
- [Security](/docs/slack/security) — Prompt injection, isolation, access control
