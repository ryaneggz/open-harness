...
- [Quickstart](/docs/getting-started/quickstart) — Start a sandbox in 3 steps
- [CLI Commands](/docs/cli/commands) — Full command reference
- [Compose Overlays](/docs/guide/overlays) — Configure optional services
- [Slack Bot](/docs/slack/overview) — Connect agents to Slack
