...
printf "  %-14s %s\n" "OS:" "Debian Bookworm"
printf "  %-14s %s\n" "Home:" "~/ ($(echo ~))"
printf "  %-14s %s\n" "Workspace:" "~/workspace/ (persisted across restarts)"
printf "\n"
printf "${BOLD}  Quick Start${NC}\n"
printf "  %-14s %s\n" "cd workspace" "Go to your persistent workspace"
...
printf "\n"
printf "${BOLD}  Tips${NC}\n"
printf "  ${DIM}-${NC} Work inside ${BOLD}~/workspace/${NC} — it's bind-mounted and persists\n"
