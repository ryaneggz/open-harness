...
# desc: the root package.json version, the .oh/cli package.json version, the
#       .oh/cli/legacy package.json version and its exact @mifune/agro pin, and a dated
...
LEGACY_PKG=".oh/cli/legacy/package.json"
