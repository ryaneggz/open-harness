 ...
 */
export declare function createStreamFn(getProxyUrl: () => Promise<string | undefined>): (model: Model<any>, context: Context, options?: SimpleStreamOptions) => Promise<import("@mariozechner/pi-ai").AssistantMessageEventStream>;
