...
date: 2026-04-29
authors: [ryan]
tags: [worktrees, agents, architecture]
draft: true
---
...
The whole pattern lives in [open-harness](https://github.com/ryaneggz/open-harness). Clone it, run `openharness sandbox up`, run `oh worktree my-first-agent`, and you have your first isolated agent workspace in under a minute. The full walkthrough is in the [docs](/docs), and the companion piece on the wider design — [Bring Your Own Harness](./byoh.md) — dropped Tuesday and explains why the harness itself is a project worth owning, not a SaaS to rent.
